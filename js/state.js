...
const State = (() => {
 ...
 const defaults = {
   ...
   posts: [
     { author: 'Lucas M.', initials: 'LM', time: 'fa 1 h', text: 'Sempre dubto si fem massa teràpies o estem sobreestimulant-lo. Com trobeu el límit per no esgotar el nen?', likes: 7, liked: false, replies: 4, color: '#508bbf' },
     { author: 'Marta F.', initials: 'MF', time: 'fa 2 h', text: 'Celebrant un gran avenç avui! La Martina ha dit la seva primera frase completa! 🎉', likes: 12, liked: false, replies: 8, color: '#00943a' },
     { author: 'Miquel P.', initials: 'MP', time: 'fa 4 h', text: 'Com gestioneu els matins escolars? Tenim moltes dificultats amb les transicions.', likes: 3, liked: false, replies: 6, color: '#9b59b6' },
   ],
   chatMessages: [
     { from: 'in', author: 'Mario G.', text: 'Hola! Algú té experiència amb el CEIP Montserrat?', time: '9:14' },
     { from: 'out', text: 'Nosaltres el coneixem bé! Molt bona atenció TEA', time: '9:16' },
     { from: 'in', author: 'Dolors L.', text: 'Sí, el fill nostre hi va. La PT és excel·lent.', time: '9:20' },
   ],
