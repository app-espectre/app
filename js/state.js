...
const State = (() => {
 ...
 const defaults = {
   ...
   posts: [
     { author: 'Laura M.', initials: 'LM', time: 'fa 1 h', text: 'Sí! El nostre fill hi va. La PT és excel·lent i molt implicada.', likes: 7, liked: false, replies: 4, color: '#508bbf' },
     { author: 'Marc F.', initials: 'MF', time: 'fa 2 h', text: 'Celebrant un gran avenç avui! La Martina ha dit la seva primera frase completa! 🎉', likes: 12, liked: false, replies: 8, color: '#00943a' },
     { author: 'Miriam P.', initials: 'MP', time: 'fa 4 h', text: 'Com gestioneu els matins escolars? Tenim moltes dificultats amb les transicions.', likes: 3, liked: false, replies: 6, color: '#9b59b6' },
   ],
   chatMessages: [
